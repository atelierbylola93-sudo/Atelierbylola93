...
export default function SoinsCorpsAlguesView() {
  return (
    <div id="soins-corps-algues-view" className="w-full pt-28 pb-10">
      ...
      <section className="relative h-[250px] md:h-[350px] flex items-center justify-center bg-black overflow-hidden rounded-b-[24px]">
        <img
          src={LUXURY_IMAGES.corpsAlgues}
          alt="Soin Corps aux algues reminéralisantes Le Pré-Saint-Gervais L'Atelier Lola"
        ...
        <div className="relative z-10 text-center space-y-3 px-4">
          ...
          <p className="text-white/80 text-xs md:text-sm italic font-serif">
            L'authentique rituel de thalasso et de bien-être thermal en plein cœur du Pré-Saint-Gervais
          </p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 md:px-8 text-center space-y-4">
        <h2 className="font-serif text-2xl md:text-3xl text-charcoal font-medium">Détoxification & Énergie Marine</h2>
        <p className="text-secondary-gray text-xs md:text-sm leading-relaxed max-w-2xl mx-auto">
          {SOINS_CORPS_ALGUES_DATA.description}
        </p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {SOINS_CORPS_ALGUES_DATA.items.map((item, idx) => (
              <div
                key={`algu-${idx}`}
      ...
      <section className="bg-white py-16 border-t border-[#B88F4D]/10">
        <FaqSection
          ...
          subtitle="Comprendre le pouvoir d'élimination de la cellulite et d'assimilation des sels minéraux purs de la mer."
        />
      </section>
